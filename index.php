              ...
              <div class="out-linksx">
				    <a href="#">
					   ...
					   if ($CFG_GLPI["use_public_faq"]) {
					      echo '<div id="xbox-faqx" style="float:left;" >'.
					            '<a style="color:#000;" href="front/helpdesk.faq.php"> '.__('Access to the Frequently Asked Questions').' ';
					      echo "</a></div>\n";
					   }
					   ?>
				    </a>
	            ...
	            <?php
					...
					&& countElementsInTable('glpi_notifications',
					      ...
					      echo '<div class="pull-right"><a href="front/lostpassword.php?lostpassword=1">'.
...
<!--            </form>-->
	...
	<?php
	  echo "</div>"; // end contenu login
	   ...
	   echo "GLPI version ".(isset($CFG_GLPI["version"])?$CFG_GLPI["version"]:"")." Copyright (C) ".date('Y').	        
	        " By Teclib'. <br />\n".
